...
export function toPvjson(graphics, currentClassLevelPvjsonAndGpmlElements) {
	...
	var gpmlToPvjsonConverter = {
		...
		FontSize: function(gpmlFontSizeValue){
			var cssFontSize;
			// TODO check this
			if (_.isNumber(parseFloat(gpmlFontSizeValue))) {
		...
		Padding: function(gpmlPaddingValue){
			var cssPadding;
			// TODO check this
			if (_.isNumber(parseFloat(gpmlPaddingValue))) {
