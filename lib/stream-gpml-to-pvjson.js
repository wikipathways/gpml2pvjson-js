...
var StreamGpmlToPvjson = function(sourceStream){
  ...
  /*
  //globalContext.push('https://raw.githubusercontent.com/wikipathways/metadata/master/json-ld-contexts/pathway.jsonld');
  globalContext.push('https://raw.githubusercontent.com/wikipathways/metadata/master/json-ld-contexts/biopax.jsonld');
  globalContext.push('https://raw.githubusercontent.com/wikipathways/metadata/master/json-ld-contexts/organism.jsonld');
  globalContext.push('https://raw.githubusercontent.com/wikipathways/metadata/master/json-ld-contexts/cellular-location.jsonld');
  globalContext.push('https://raw.githubusercontent.com/wikipathways/metadata/master/json-ld-contexts/display.jsonld');
  //globalContext.push('https://raw.githubusercontent.com/wikipathways/metadata/master/json-ld-contexts/interaction-type.jsonld');
  //*/
  /*
  //globalContext.push('https://wikipathways.github.io/metadata/json-ld-contexts/pathway.jsonld');
  globalContext.push('https://wikipathways.github.io/metadata/json-ld-contexts/pathway.jsonld/biopax.jsonld');
  globalContext.push('https://wikipathways.github.io/metadata/json-ld-contexts/pathway.jsonld/organism.jsonld');
  globalContext.push('https://wikipathways.github.io/metadata/json-ld-contexts/pathway.jsonld/cellular-location.jsonld');
  globalContext.push('https://wikipathways.github.io/metadata/json-ld-contexts/pathway.jsonld/display.jsonld');
  //globalContext.push('https://wikipathways.github.io/metadata/json-ld-contexts/pathway.jsonld/interaction-type.jsonld');
  //*/
    ...
    if (tagNamesForTargetElements.indexOf(x.name) > -1) {
      if (x.name !== 'Pathway') {
        ...
        if (GpmlUtilities.supportedNamespaces.indexOf(xmlns) === -1) {
          ...
          return 'Pvjs does not support the data format provided. Please convert to valid GPML and retry.';
        } else if (GpmlUtilities.supportedNamespaces.indexOf(xmlns) !== 0) {
          // test for whether the GPML file version matches the latest version (only the latest version will be supported by pvjs).
          // TODO call the Java RPC updater or in some other way call for the file to be updated.
          saxStreamFiltered.destroy();
          return 'Pvjs may not fully support the version of GPML provided (xmlns: ' + xmlns + '). Please convert to the supported version of GPML (xmlns: ' + GpmlUtilities.supportedNamespaces[0] + ').';
        }
