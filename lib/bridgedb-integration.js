...
var filename = 'gpml2pvjson-js/lib/bridgedb-integration.js';
...
function enrichEntityReference(bridgeDb, context, entityReference, entity) {
  ...
  var enrichedEntityReferenceSource = RxNode.fromUnpausableStream(
  ...
  var errorHandlerSource = Rx.Observable.return({})
    .flatMap(function() {
      ...
      if (lastEnrichedEntityReferenceSourceError.code === 'ENTITYREFERENCEMISSINGDATA') {
        if (dataset) {
          return RxNode.fromUnpausableStream(bridgeDb.dataset.get(dataset))
