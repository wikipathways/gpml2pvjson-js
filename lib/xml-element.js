...
var gpmlDataNodeTypeToBiopaxEntityTypeMappings = utils.gpmlDataNodeTypeToBiopaxEntityTypeMappings;
  ...
  toPvjson: function(args) {
    ...
    var gpmlToPvjsonConverter = {
      ...
      'gpml:BiopaxRef': function(gpmlValue) {
        ...
        pvjsonElement.xref = pvjsonElement.xref.concat(gpmlValue);
      },
      ...
      Type: function(gpmlValue) {
        ...
        if (tagName === 'DataNode') {
          // Convert GPML DataNode Type to a value from a vocabulary like GPML or BioPAX
          pvjsonElement.type = gpmlDataNodeTypeMappings[gpmlValue] || 'PhysicalEntity';
        } else {
