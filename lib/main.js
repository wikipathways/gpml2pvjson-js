...
var Gpml2Pvjson = function() {
  ...
  this.toPvjson = function(gpmlPathwaySelection, pathwayMetadata, outerCallback) {
    ...
    gpmlPathwaySelection = instance.fixBiopax(
        instance.syncGroupIdWithGraphId(instance.makeExplicit(gpmlPathwaySelection)));
    var pvjson = {};
  ...
  this.toPvjsonSource = function(gpmlStringSource, pathwayMetadata) {
    return instance.fixGpmlAndConvertToPvjsonSource(gpmlStringSource, pathwayMetadata)
      .map(function(result) {
  ...
  this.getGpmlAndConvertToPvjsonSource = function(gpmlStringSource, pathwayMetadata) {
  ...
  this.syncGroupIdWithGraphId = function(gpmlPathwaySelection) {
